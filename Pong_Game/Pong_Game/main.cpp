...
Color Blue = Color{ 46, 56, 158, 255 };
Color Dark_Blue = Color{ 46, 46, 132, 255 };
Color Light_Blue = Color{ 46, 132, 215, 180 };
Color Yellow = Color{ 255, 229, 91, 255 };
...
int main() {
	...
	while (WindowShouldClose() == false) {
		...
		DrawLine(screen_width/2, 0, screen_width/2, screen_height, Light_Blue);
		ball.Draw();
		cpu.Draw();
		player.Draw();
